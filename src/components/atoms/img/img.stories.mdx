...
import DemoImage from '../../../assets/static/logo.png';
...
<Story name="Größe anpassen">
  <StyledImgStoryContainer>
    <Img src={DemoImage} width={200} height={200} />
    <Img src={DemoImage} width={150} height={150} />
    <Img src={DemoImage} width={100} height={100} />
    <Img src={DemoImage} width={80} height={80} />
    <Img src={DemoImage} width={60} height={60} />
  </StyledImgStoryContainer>
</Story>
